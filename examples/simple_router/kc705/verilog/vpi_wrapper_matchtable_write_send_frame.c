 ...
 *     #include "vpi_wrapper_matchtable_write_send_frame.h"
 *     void (*vlog_startup_routines[])() = { matchtable_write_send_frame_vpi_register, 0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
void matchtable_write_send_frame(unsigned int , char );
...
PLI_INT32 matchtable_write_send_frame_calltf(PLI_BYTE8 *user_data)
{
  ...
  matchtable_write_send_frame(arg_1, arg_2);
...
void matchtable_write_send_frame_vpi_register()
{
  ...
  tf_data.tfname = "$imported_matchtable_write_send_frame";
  tf_data.calltf = matchtable_write_send_frame_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_matchtable_write_send_frame";
