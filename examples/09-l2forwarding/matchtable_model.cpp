...
extern "C" ForwardTblReqT matchtable_read_forward_tbl(ForwardTblReqT rdata) {
...
extern "C" void matchtable_write_forward_tbl(ForwardTblReqT wdata, ForwardTblRspT action){
